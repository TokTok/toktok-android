...
class FriendsRecyclerHeaderAdapter(list: ListBuffer[Friend],friendPhotoOnClick: FriendItemClicks) extends FriendsRecyclerAdapter(list,friendPhotoOnClick) with StickyRecyclerHeadersAdapter[RecyclerView.ViewHolder] {
