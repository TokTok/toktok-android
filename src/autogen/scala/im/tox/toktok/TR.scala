...
object TR {
  ...
  final val message_item_action_cardview = TypedResource[android.support.v7.widget.CardView](R.id.message_item_action_cardview)
  ...
  object string {
    ...
    final val user_name = TypedRes[TypedResource.ResString](R.string.user_name)
